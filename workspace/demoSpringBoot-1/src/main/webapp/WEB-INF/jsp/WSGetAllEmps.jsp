                ...
                <body style='background-color:#fdf5e6'>
                    ...
                    <div class="center">
                        ...
                        <form method="get" action="/WSSearchByDate" enctype="multipart/form-data">
                            活動開始時間 : <input type="date" id="EVENT_STARTIME" name="startTime" /><button
                            ...
                            <tbody>
                                <c:forEach items="${eventBeans}" var="evBean">
                                    <tr>
                                        ...
                                        <td>${evBean.signupStartime}</td>
                                        <td>${evBean.signupEndtime}</td>
                                        <td>${evBean.startTime}</td>
                                        <td>${evBean.endTime}</td>
                                        ...
                                        <td>
                                            <form action="${pageContext.request.contextPath}/Event" method="post">
                                                ...
                                                <input type="hidden" name="PRODUCTID" value="${evBean.eventId}">
