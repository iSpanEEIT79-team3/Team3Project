...
<div style="float: right;">
    <form method="get" action="/html/LTTitleFront.html" style="margin-bottom: 10px;">
        <input type="hidden" name="title" />
        <button class="btn btn-info btn-sm title" type="submit" style="padding: 10px;">搜尋標題</button>
    </form>
    <!-- 將"搜尋文章ID"表單移到這裡 -->
    <form method="Get" action="html/LTSelectFront.html">
        <button class="btn btn-info btn-sm select" type="submit" style="padding: 10px;">搜尋文章ID</button>
    </form>
</div>
